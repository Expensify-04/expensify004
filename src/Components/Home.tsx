...
//               Your all-in-one platform to track spending, budget wisely, and achieve your financial
//               goals.
//             </p>
        ...
        <section className="bg-gradient-to-br from-indigo-50 to-white min-h-screen pt-24 pb-4 px-4">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-indigo-600 text-white px-6 py-3 rounded-md hover:bg-indigo-700 transition shadow-lg text-lg cursor-pointer"
            >
              Start Tracking Now
            </motion.button>
          </motion.div>
